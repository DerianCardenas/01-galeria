  ...
  <div class="login-container">
    ...
    <div class="form-section">
      <div class="form-wrapper">
        ...
        <h1 class="font-headings">REGISTRA TU CUENTA</h1>
        ...
        <button @click="login" class="login-button">Registrarse</button>

        <p class="tagline">¡Almacena todas tus fotos en un solo lugar!</p>
        <p class="register-link" @click="router.push('/login')">¿yA tienes cuenta? <span>Inicia sesión</span></p>
      </div>
    </div>
